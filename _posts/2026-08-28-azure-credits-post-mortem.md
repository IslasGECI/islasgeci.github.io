...
Tenemos una dependencia fuerte con el director de CD como administrador/gestor de la donación de Azure y AWS. Si podemos hacernos cargo de esta responsabilidad, tal vez la detección y la respuesta hubieran sido un poco más ágiles.
