...
Escribíamos la sección del reporte como si no hubiera diferencias en el **pico de la masa**.
...
## Cinco "¿por qué?"
1. ¿Por qué en el reporte del 28 de mayo sí hay diferencias en el **pico de la masa**?

- Porque la sección de las diferencias entre temporadas del **pico de la masa** no se renderiza correctamente.
...
- Es malo reescribir los archivos JSON.
